package gds.demo.repository;

import gds.demo.JhiOauth2App1App;
import gds.demo.config.Constants;
import gds.demo.config.TestSecurityConfiguration;
import gds.demo.config.audit.AuditEventConverter;
import gds.demo.domain.PersistentAuditEvent;
...
import static gds.demo.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
