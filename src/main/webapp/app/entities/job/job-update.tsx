    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="jhiOauth2App1App.job.home.createOrEditLabel">
              <Translate contentKey="jhiOauth2App1App.job.home.createOrEditLabel">Create or edit a Job</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : jobEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label for="job-task">
                    <Translate contentKey="jhiOauth2App1App.job.task">Task</Translate>
                  </Label>
                  <AvInput
                    id="job-task"
                    type="select"
