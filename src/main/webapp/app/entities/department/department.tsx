    ...
    return (
      <div>
        <h2 id="department-heading">
          <Translate contentKey="jhiOauth2App1App.department.home.title">Departments</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="jhiOauth2App1App.department.home.createLabel">Create new Department</Translate>
          </Link>
        </h2>
        <div className="table-responsive">
          {departmentList && departmentList.length > 0 ? (
            <Table responsive>
              <thead>
                <tr>
                  ...
                  <th>
                    <Translate contentKey="jhiOauth2App1App.department.departmentName">Department Name</Translate>
                  </th>
                  <th>
                    <Translate contentKey="jhiOauth2App1App.department.location">Location</Translate>
                  </th>
                  <th />
                </tr>
              </thead>
            ...
            <div className="alert alert-warning">
              <Translate contentKey="jhiOauth2App1App.department.home.notFound">No Departments found</Translate>
            </div>
          )}
        </div>
      </div>
