  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="jhiOauth2App1App.department.delete.question">
          <Translate contentKey="jhiOauth2App1App.department.delete.question" interpolate={{ id: departmentEntity.id }}>
