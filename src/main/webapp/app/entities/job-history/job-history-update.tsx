    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="jhiOauth2App1App.jobHistory.home.createOrEditLabel">
              <Translate contentKey="jhiOauth2App1App.jobHistory.home.createOrEditLabel">Create or edit a JobHistory</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : jobHistoryEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="startDateLabel" for="job-history-startDate">
                    <Translate contentKey="jhiOauth2App1App.jobHistory.startDate">Start Date</Translate>
                  </Label>
                  <AvInput
                ...
                <AvGroup>
                  <Label id="endDateLabel" for="job-history-endDate">
                    <Translate contentKey="jhiOauth2App1App.jobHistory.endDate">End Date</Translate>
                  </Label>
                  <AvInput
                ...
                <AvGroup>
                  <Label id="languageLabel" for="job-history-language">
                    <Translate contentKey="jhiOauth2App1App.jobHistory.language">Language</Translate>
                  </Label>
                  <AvInput
                  ...
                  >
                    <option value="FRENCH">{translate('jhiOauth2App1App.Language.FRENCH')}</option>
                    <option value="ENGLISH">{translate('jhiOauth2App1App.Language.ENGLISH')}</option>
                    <option value="SPANISH">{translate('jhiOauth2App1App.Language.SPANISH')}</option>
                  </AvInput>
                </AvGroup>
                <AvGroup>
                  <Label for="job-history-job">
                    <Translate contentKey="jhiOauth2App1App.jobHistory.job">Job</Translate>
                  </Label>
                ...
                <AvGroup>
                  <Label for="job-history-department">
                    <Translate contentKey="jhiOauth2App1App.jobHistory.department">Department</Translate>
                  </Label>
                ...
                <AvGroup>
                  <Label for="job-history-employee">
                    <Translate contentKey="jhiOauth2App1App.jobHistory.employee">Employee</Translate>
                  </Label>
