  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="jhiOauth2App1App.jobHistory.delete.question">
          <Translate contentKey="jhiOauth2App1App.jobHistory.delete.question" interpolate={{ id: jobHistoryEntity.id }}>
