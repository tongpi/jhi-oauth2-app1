    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="jhiOauth2App1App.employee.home.createOrEditLabel">
              <Translate contentKey="jhiOauth2App1App.employee.home.createOrEditLabel">Create or edit a Employee</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : employeeEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="firstNameLabel" for="employee-firstName">
                    <Translate contentKey="jhiOauth2App1App.employee.firstName">First Name</Translate>
                  </Label>
                  <AvField id="employee-firstName" type="text" name="firstName" />
                  <UncontrolledTooltip target="firstNameLabel">
                    <Translate contentKey="jhiOauth2App1App.employee.help.firstName" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="lastNameLabel" for="employee-lastName">
                    <Translate contentKey="jhiOauth2App1App.employee.lastName">Last Name</Translate>
                  </Label>
                  <AvField id="employee-lastName" type="text" name="lastName" />
                </AvGroup>
                <AvGroup>
                  <Label id="emailLabel" for="employee-email">
                    <Translate contentKey="jhiOauth2App1App.employee.email">Email</Translate>
                  </Label>
                  <AvField id="employee-email" type="text" name="email" />
                </AvGroup>
                <AvGroup>
                  <Label id="phoneNumberLabel" for="employee-phoneNumber">
                    <Translate contentKey="jhiOauth2App1App.employee.phoneNumber">Phone Number</Translate>
                  </Label>
                  <AvField id="employee-phoneNumber" type="text" name="phoneNumber" />
                </AvGroup>
                <AvGroup>
                  <Label id="hireDateLabel" for="employee-hireDate">
                    <Translate contentKey="jhiOauth2App1App.employee.hireDate">Hire Date</Translate>
                  </Label>
                  <AvInput
                ...
                <AvGroup>
                  <Label id="salaryLabel" for="employee-salary">
                    <Translate contentKey="jhiOauth2App1App.employee.salary">Salary</Translate>
                  </Label>
                ...
                <AvGroup>
                  <Label for="employee-department">
                    <Translate contentKey="jhiOauth2App1App.employee.department">Department</Translate>
                  </Label>
                ...
                <AvGroup>
                  <Label for="employee-manager">
                    <Translate contentKey="jhiOauth2App1App.employee.manager">Manager</Translate>
                  </Label>
