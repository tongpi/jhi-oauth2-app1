    ...
    return (
      <div>
        <h2 id="employee-heading">
          <Translate contentKey="jhiOauth2App1App.employee.home.title">Employees</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="jhiOauth2App1App.employee.home.createLabel">Create new Employee</Translate>
          </Link>
        </h2>
          ...
          >
            {employeeList && employeeList.length > 0 ? (
                ...
                <thead>
                  <tr>
                    ...
                    <th className="hand" onClick={this.sort('firstName')}>
                      <Translate contentKey="jhiOauth2App1App.employee.firstName">First Name</Translate> <FontAwesomeIcon icon="sort" />
                    </th>
                    <th className="hand" onClick={this.sort('lastName')}>
                      <Translate contentKey="jhiOauth2App1App.employee.lastName">Last Name</Translate> <FontAwesomeIcon icon="sort" />
                    </th>
                    <th className="hand" onClick={this.sort('email')}>
                      <Translate contentKey="jhiOauth2App1App.employee.email">Email</Translate> <FontAwesomeIcon icon="sort" />
                    </th>
                    <th className="hand" onClick={this.sort('phoneNumber')}>
                      <Translate contentKey="jhiOauth2App1App.employee.phoneNumber">Phone Number</Translate> <FontAwesomeIcon icon="sort" />
                    </th>
                    <th className="hand" onClick={this.sort('hireDate')}>
                      <Translate contentKey="jhiOauth2App1App.employee.hireDate">Hire Date</Translate> <FontAwesomeIcon icon="sort" />
                    </th>
                    <th className="hand" onClick={this.sort('salary')}>
                      <Translate contentKey="jhiOauth2App1App.employee.salary">Salary</Translate> <FontAwesomeIcon icon="sort" />
                    </th>
                    <th className="hand" onClick={this.sort('commissionPct')}>
                      <Translate contentKey="jhiOauth2App1App.employee.commissionPct">Commission Pct</Translate>{' '}
                      <FontAwesomeIcon icon="sort" />
                    </th>
                    <th>
                      <Translate contentKey="jhiOauth2App1App.employee.department">Department</Translate> <FontAwesomeIcon icon="sort" />
                    </th>
                    <th>
                      <Translate contentKey="jhiOauth2App1App.employee.manager">Manager</Translate> <FontAwesomeIcon icon="sort" />
                    </th>
                    <th />
                  </tr>
                </thead>
              ...
              <div className="alert alert-warning">
                <Translate contentKey="jhiOauth2App1App.employee.home.notFound">No Employees found</Translate>
              </div>
            )}
          </InfiniteScroll>
        </div>
