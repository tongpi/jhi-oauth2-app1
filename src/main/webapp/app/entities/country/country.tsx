    ...
    return (
      <div>
        <h2 id="country-heading">
          <Translate contentKey="jhiOauth2App1App.country.home.title">Countries</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="jhiOauth2App1App.country.home.createLabel">Create new Country</Translate>
          </Link>
        </h2>
        <div className="table-responsive">
          {countryList && countryList.length > 0 ? (
            <Table responsive>
              <thead>
                <tr>
                  ...
                  <th>
                    <Translate contentKey="jhiOauth2App1App.country.countryName">Country Name</Translate>
                  </th>
                  <th>
                    <Translate contentKey="jhiOauth2App1App.country.region">Region</Translate>
                  </th>
                  <th />
                </tr>
              </thead>
            ...
            <div className="alert alert-warning">
              <Translate contentKey="jhiOauth2App1App.country.home.notFound">No Countries found</Translate>
            </div>
          )}
        </div>
      </div>
