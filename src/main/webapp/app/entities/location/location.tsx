    ...
    return (
      <div>
        <h2 id="location-heading">
          <Translate contentKey="jhiOauth2App1App.location.home.title">Locations</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="jhiOauth2App1App.location.home.createLabel">Create new Location</Translate>
          </Link>
        </h2>
        <div className="table-responsive">
          {locationList && locationList.length > 0 ? (
            <Table responsive>
              <thead>
                <tr>
                  ...
                  <th>
                    <Translate contentKey="jhiOauth2App1App.location.streetAddress">Street Address</Translate>
                  </th>
                  <th>
                    <Translate contentKey="jhiOauth2App1App.location.postalCode">Postal Code</Translate>
                  </th>
                  <th>
                    <Translate contentKey="jhiOauth2App1App.location.city">City</Translate>
                  </th>
                  <th>
                    <Translate contentKey="jhiOauth2App1App.location.stateProvince">State Province</Translate>
                  </th>
                  <th>
                    <Translate contentKey="jhiOauth2App1App.location.country">Country</Translate>
                  </th>
                  <th />
                </tr>
              </thead>
            ...
            <div className="alert alert-warning">
              <Translate contentKey="jhiOauth2App1App.location.home.notFound">No Locations found</Translate>
            </div>
          )}
        </div>
      </div>
