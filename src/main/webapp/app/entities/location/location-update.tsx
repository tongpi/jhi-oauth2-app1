    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="jhiOauth2App1App.location.home.createOrEditLabel">
              <Translate contentKey="jhiOauth2App1App.location.home.createOrEditLabel">Create or edit a Location</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
